...
//$id = @$_GET['id'];
$sql_code = "SELECT  * FROM estoque e INNER JOIN produto p ON  e.esto_id_produto=p.pro_id
									   WHERE esto_id=$estoque";
$query3 = mysql_query($sql_code);
	
	$res =@mysql_fetch_assoc($query3);
	$cat_produto = $res['esto_id'];
  ?>
...
<?php include "menu.php"; ?>
  ...
  <div class="content-wrapper">
	...
	<form method="POST" action="estoquePdf.php" target="_blank">
